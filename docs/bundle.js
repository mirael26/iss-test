...
var map = {
	"./apple-iphone-12.png": 795,
	"./apple-iphone-xr.png": 218,
	"./arrow-down.svg": 292,
	"./change-arrows.svg": 261,
	"./check-mark.svg": 453,
	"./check.png": 903,
	"./cross-mark.svg": 361,
	"./realme-8-pro.png": 959,
	"./samsung-galaxy-a72.png": 325,
	"./samsung-galaxy-s21.png": 734,
	"./user-icon.svg": 716,
	"./xiaomi-mi-11-lite-1.png": 77
};
...
"use strict";
module.exports = __webpack_require__.p + "images/apple-iphone-12.png";
...
"use strict";
module.exports = __webpack_require__.p + "images/apple-iphone-xr.png";
...
"use strict";
module.exports = __webpack_require__.p + "images/change-arrows.svg";
...
"use strict";
module.exports = __webpack_require__.p + "images/check-mark.svg";
...
"use strict";
module.exports = __webpack_require__.p + "images/cross-mark.svg";
...
"use strict";
module.exports = __webpack_require__.p + "images/realme-8-pro.png";
...
"use strict";
module.exports = __webpack_require__.p + "images/samsung-galaxy-a72.png";
...
"use strict";
module.exports = __webpack_require__.p + "images/samsung-galaxy-s21.png";
...
"use strict";
module.exports = __webpack_require__.p + "images/user-icon.svg";
...
"use strict";
module.exports = __webpack_require__.p + "images/xiaomi-mi-11-lite-1.png";
...
var ActionCreator = {
    updateDisplayedPhones: function (displayedPhones) { return ({
        type: ActionType.UPDATE_DISPLAYED_PHONES,
        payload: displayedPhones
    }); },
    changePhonesAmount: function (amount) { return ({
        type: ActionType.CHANGE_PHONES_AMOUNT,
        payload: amount
    }); }
};

;// CONCATENATED MODULE: ./src/mocks.ts
var phonesMocks = [
    {
        id: 0,
...
var reducer = function (state, action) {
    ...
    switch (action.type) {
        case ActionType.UPDATE_DISPLAYED_PHONES:
            return __assign(__assign({}, state), { displayedPhones: action.payload });
        case ActionType.CHANGE_PHONES_AMOUNT:
            return __assign(__assign({}, state), { phonesAmount: action.payload });
        default:
            return state;
    }
};
...
var Header = function () {
    return (react.createElement("div", { className: "header" },
        react.createElement("nav", { className: "header__nav" },
            react.createElement("a", null, "\u041A\u0430\u0442\u0430\u043B\u043E\u0433")),
        react.createElement("h1", { className: "header__title" }, "\u0421\u0440\u0430\u0432\u043D\u0435\u043D\u0438\u0435"),
        react.createElement("button", { className: "header__account" }, "\u041B\u0438\u0447\u043D\u044B\u0439 \u043A\u0430\u0431\u0438\u043D\u0435\u0442")));
};
/* harmony default export */ var header = (Header);

;// CONCATENATED MODULE: ./src/components/amount-filter/amount-filter.tsx



var AmountFilter = function () {
    var phones = useSelector(function (state) { return state.phones; });
    var amount = useSelector(function (state) { return state.phonesAmount; });
    var dispatch = useDispatch();
    var buttons = [];
    if (phones.length > 1) {
        for (var i = 2; i <= phones.length && i <= 6; i++) {
            buttons.push(i);
        }
    }
    ...
    return (phones.length > 1
        ? react.createElement("div", { className: "amount-filter" },
            react.createElement("p", { className: "amount-filter__text" }, "\u041E\u0442\u043E\u0431\u0440\u0430\u0437\u0438\u0442\u044C \u0442\u043E\u0432\u0430\u0440\u044B:"),
            buttons.map(function (button, i) {
                return react.createElement("button", { key: "button-".concat(i), className: "amount-filter__button".concat(button === amount ? " active" : ""), disabled: button === amount, onClick: function (evt) { return onButtonClick(evt); } }, button);
            }))
        : react.createElement("div", null));
};
/* harmony default export */ var amount_filter = (AmountFilter);
...
;// CONCATENATED MODULE: ./src/components/replace/replace.tsx




var Replace = function (_a) {
    var _b = _a.className, className = _b === void 0 ? "" : _b, currentId = _a.currentId;
    var phones = useSelector(function (state) { return state.phones; });
    var displayedPhones = useSelector(function (state) { return state.displayedPhones; });
    var dispatch = useDispatch();
    var _c = (0,react.useState)(null), searchedPhones = _c[0], setSearchedPhones = _c[1];
    var undisplayedPhones = phones.filter(function (phone) {
        return !displayedPhones.find(function (displayedPhone) { return phone.id === displayedPhone.id; });
    });
    var replacePhones = function (evt) {
        var element = evt.target;
        var index = displayedPhones.findIndex(function (element) { return element.id === currentId; });
        var updatedPhones = displayedPhones.slice();
        updatedPhones[index] = phones.find(function (phone) { return phone.id === Number(element.id); });
        dispatch(ActionCreator.updateDisplayedPhones(updatedPhones));
    };
    var searchPhones = function (evt) {
        var searchingText = evt.target.value;
        if (searchingText === "") {
            searchedPhones ? setSearchedPhones(null) : null;
            return;
        }
        var result = undisplayedPhones.filter(function (phone) {
            var searchRegexp = new RegExp("^".concat(searchingText, "| ").concat(searchingText), 'i');
            return searchRegexp.test(phone.name);
        });
        setSearchedPhones(result);
    };
    var resultPhones = searchedPhones ? searchedPhones : undisplayedPhones;
    return (react.createElement("div", { className: "replace ".concat(className) },
        undisplayedPhones.length > 3
            ? react.createElement("input", { className: "replace__search-input", type: "text", placeholder: "\u041F\u043E\u0438\u0441\u043A", onChange: function (evt) { return searchPhones(evt); } })
            : null,
        react.createElement("ul", { className: "replace__phone-list" }, resultPhones.map(function (phone, i) {
            return react.createElement("li", { key: "replace-phone-".concat(i), className: "replace__phone-item" },
                react.createElement("button", { className: "replace__phone-change-button", id: phone.id.toString(), onClick: function (evt) { return replacePhones(evt); } }, "\u0417\u0430\u043C\u0435\u043D\u0438\u0442\u044C"),
                react.createElement("div", { className: "replace__phone-image-container" },
                    react.createElement("img", { className: "replace__phone-image", src: __webpack_require__(327)("./".concat(phone.image)), alt: phone.name })),
                react.createElement("p", { className: "replace__phone-text" }, phone.name));
        }))));
};
/* harmony default export */ var replace = (Replace);
...
var Phone = function (_a) {
    var _b = _a.isLast, isLast = _b === void 0 ? false : _b, image = _a.image, name = _a.name, id = _a.id, isUndisplayedPhones = _a.isUndisplayedPhones;
    var _c = (0,react.useState)(false), isReplaceOpen = _c[0], setReplaceOpen = _c[1];
    ...
    var closeReplacePopup = function (evt) {
        var element = evt.target;
        var replaceBlock = document.querySelector('.phone__replace');
    ...
    return (react.createElement("div", { className: "phone" },
        react.createElement("img", { className: "phone__image", src: __webpack_require__(327)("./".concat(image)), alt: name }),
        react.createElement("p", { className: "phone__text" }, name),
        isUndisplayedPhones
            ?
                isReplaceOpen
                    ? react.createElement(replace, { className: "phone__replace".concat(isLast ? " phone__replace--last" : ""), currentId: id })
                    : react.createElement("button", { className: "phone__replace-button", onClick: function () { return setReplaceOpen(true); } }, "\u0417\u0430\u043C\u0435\u043D\u0438\u0442\u044C \u0442\u0435\u043B\u0435\u0444\u043E\u043D")
            : null));
};
/* harmony default export */ var phone_phone = (Phone);

;// CONCATENATED MODULE: ./src/components/comparison-table/comparison-table.tsx
...
var updatePhones = function (phones, displayedPhones, amount) {
    if (displayedPhones.length >= amount) {
        return displayedPhones.slice(0, amount);
    }
    var newPhones = displayedPhones.slice();
    while (newPhones.length < amount) {
        var addedPhone = phones.find(function (phone) { return !newPhones.includes(phone); });
...
var ComparisonTable = function () {
    ...
    var displayedPhones = useSelector(function (state) { return state.displayedPhones; });
    var dispatch = useDispatch();
    var _a = (0,react.useState)(false), differencesOn = _a[0], setDifferences = _a[1];
    (0,react.useEffect)(function () {
    ...
    var findDifferentProperties = function (properties) {
        return properties.filter(function (property) {
            var phoneProperties = displayedPhones.map(function (phone) { return phone[property]; });
    ...
    var comparedProperties = differencesOn ? findDifferentProperties(Object.keys(TableHeaders)) : Object.keys(TableHeaders);
    var isUndisplayedPhones = !(phones.length === amount);
    return (react.createElement("div", { className: "comparison-table" },
        react.createElement("div", { className: "comparison-table__header" },
            react.createElement("div", { className: "comparison-table__header-cell" },
                react.createElement("button", { className: "comparison-table__differences-checkbox".concat(differencesOn ? ' checked' : ''), onClick: function () { return setDifferences(!differencesOn); } },
                    react.createElement("p", { className: "comparison-table__differences-checkbox-label" }, "\u041F\u043E\u043A\u0430\u0437\u0430\u0442\u044C \u0440\u0430\u0437\u043B\u0438\u0447\u0438\u044F"))),
            displayedPhones.map(function (phone, i) {
                var isLast = (i === (displayedPhones.length - 1)) ? true : false;
                return react.createElement("div", { key: "phone-".concat(i), className: "comparison-table__cell comparison-table__cell--columns-".concat(amount) },
                    react.createElement(phone_phone, { isLast: isLast, image: phone.image, name: phone.name, id: phone.id, isUndisplayedPhones: isUndisplayedPhones }));
            })),
        react.createElement("div", { className: "comparison-table__body" }, comparedProperties.map(function (header, i) {
            return react.createElement("div", { key: "row-".concat(i), className: "comparison-table__row" },
                react.createElement("div", { className: "comparison-table__header-cell" }, TableHeaders[header]),
                displayedPhones.map(function (phone, i) {
                    var content = typeof phone[header] !== "boolean"
                        ? "".concat(phone[header]).concat(header === "cost" ? " ₽" : "")
                        : react.createElement("div", { className: "comparison-table__boolean-icon comparison-table__boolean-icon--".concat(phone[header]) }, phone[header] === true ? "Да" : "Нет");
                    return react.createElement("div", { key: "".concat(header, "-cell-").concat(i), className: "comparison-table__cell comparison-table__cell--columns-".concat(amount) }, content);
                }));
        }))));
};
/* harmony default export */ var comparison_table = (ComparisonTable);

;// CONCATENATED MODULE: ./src/components/comparison-page/comparison-page.tsx



var ComparisonPage = function () {
    return (react.createElement("div", { className: "comparison-page" },
        react.createElement("div", { className: "comparison-page__header" },
            react.createElement("h2", { className: "comparison-page__title" }, "\u0421\u043C\u0430\u0440\u0442\u0444\u043E\u043D\u044B"),
            react.createElement(amount_filter, null)),
        react.createElement(comparison_table, null)));
};
/* harmony default export */ var comparison_page = (ComparisonPage);
...
var App = function () {
    return (react.createElement("div", { className: "app" },
        ...
        react.createElement(comparison_page, null)));
};
